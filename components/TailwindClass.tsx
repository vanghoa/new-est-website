...
export const tw_line_divider = '!tw-leading-[2.5rem]';
export const scultpclass =
    'tw-w-full tw-h-[var(--vh100)] tw-bg-transparent tw-left-0 tw-top-0';

export const tw_grid_section =
    'tw-grid tw-grid-cols-[min-content_auto_min-content] tw-grid-rows-[1.1em_auto_min-content]';
